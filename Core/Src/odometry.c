...
void Odometry_Update(float imu_yaw, float dt) {
  ...
  float s1 = MotorControl_GetSpeedMMps(0); /* M1 左前 */
  float s2 = MotorControl_GetSpeedMMps(1); /* M2 右前 */
  float s3 = MotorControl_GetSpeedMMps(2); /* M3 右后 */
  float s4 = MotorControl_GetSpeedMMps(3); /* M4 左后 */
